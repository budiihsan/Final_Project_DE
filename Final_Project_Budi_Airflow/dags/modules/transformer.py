...
class Transformer():
    ...
    def create_dimension_province(self):
        ...
        print("INSERT TO POSTGRES SUCCESSFULLY")
    
    def create_dimension_district(self):
        df = self.get_data_from_mysql()
        df_district_dimension = df[['kode_prov', 'nama_prov']]
        df_district_dimension = df_district_dimension.rename(columns={ 'kode_prov':'province_id','nama_prov':'district_name'})
    ...
    def create_dimension_case(self):
        df = self.get_data_from_mysql()
        column_start = ['suspect_diisolasi', 'suspect_discarded', 'closecontact_dikarantina', 'closecontact_discarded', 'probable_diisolasi', 'probable_discarded', 
                        'confirmation_meninggal', 'probable_meninggal']
    ...
    def create_province_daily(self):
        ...
        column_start = ['tanggal', 'kode_prov', 'suspect_diisolasi', 'suspect_discarded', 'closecontact_dikarantina', 'closecontact_discarded', 'probable_diisolasi', 
                        'probable_discarded', 'confirmation_meninggal', 'probable_meninggal']
    ...
    def create_district_daily(self): 
        ...
        column_start = ['tanggal', 'kode_prov', 'suspect_diisolasi', 'suspect_discarded', 'closecontact_dikarantina', 'closecontact_discarded', 'probable_diisolasi', 'probable_discarded', 
                        'confirmation_meninggal', 'probable_meninggal']
